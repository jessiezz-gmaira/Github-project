...
with dates as (
select '2021-12-01'::date as start_date, '2021-12-31'::date as end_date
//        select date_trunc('month',add_months(current_date, -1))::date as start_date, 
//              last_day(date_trunc('month',add_months(current_date, -1)))::date as end_date
