...
CREATE OR REPLACE TABLE VODSR_GM_100522 as
...
CREATE OR REPLACE TABLE VODSR_sample_GM_100522_roku  as
...
where a.app_name in ('roku') and month >= '2022-07-01'
    and (b.event_name in ('vodEpisodeWatch', 'episodeStart') OR
...
CREATE OR REPLACE TABLE VODSR_sample2_GM_100522_roku  as
with base as
...
from VODSR_sample_GM_100522_roku a
...
CREATE OR REPLACE TABLE VODSR_flow_GM_100522_roku  as
...
match_number, msq, cl from VODSR_sample2_GM_100522_roku
  match_recognize(
